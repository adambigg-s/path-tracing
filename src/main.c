...
int main(int argc, char *argv[]) {
    Camera camera = camera_build(1920, 1080, 10);

    Material mat_ground = {.type = Metal, .albedo = vec3_build(0.1, 0.1, 0.1), .fuzzy = 0.7};
    ...
    Material mat_large_inner = {.type = Metal, .albedo = vec3_build(0.9, 0.5, 0.2), .fuzzy = 0.1};
